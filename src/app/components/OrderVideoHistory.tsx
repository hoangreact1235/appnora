...
import { mockOrderVideoHistory } from "../mock/orderVideoHistory";
import dayjs from "dayjs";

export default function OrderVideoHistory() {
  return (
    <div className="mt-8">
      <h2 className="text-lg font-bold text-[#D81B60] mb-4">Lịch sử Order Video</h2>
        ...
        <table className="min-w-full bg-white border border-[#F3C1D7] rounded-md">
          <thead>
            <tr className="bg-[#FDE7F0] text-[#D81B60]">
              ...
              <th className="px-4 py-2 text-left">Loại video</th>
          ...
          <tbody>
            {mockOrderVideoHistory.map((order) => (
